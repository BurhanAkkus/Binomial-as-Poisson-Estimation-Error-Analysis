...
with open('distribution_differences.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
    # Write the header
    writer.writerow(['n', 'p', 'KL Divergence', 'Jensen-Shannon Divergence', 'Wasserstein Distance'])
    ...
    for n in n_array:
        for p in p_array:
            ...
            if binom_sum > 0 and poisson_sum > 0:
                ...
                writer.writerow([n, p, kl_div, js_div, wasser_dist])
